...
### 1-7 starwars 에서 NA는 몇개나 있는지 확인하시오
...
### 2-3 세로줄 "월"에 값이 없는 것들을 제거해 변수에 저장하시오

> drop_na() <br> 변수명: kobis2019_2date
...
> drop_na() <br> group_by() <br> summarise() <br>
...
### 2-7 (2-6 결과를 바탕으로) 그래프 심미성을 높이시오
...
### 2-8 bbc_style을 theme을 활용해 구현하시오 (선택)
